...
HD_PWD='C:/Users/Steven/Dropbox/Vivado/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log demo.vdi -applog -m64 -messageDb vivado.pb -mode batch -source demo.tcl -notrace
