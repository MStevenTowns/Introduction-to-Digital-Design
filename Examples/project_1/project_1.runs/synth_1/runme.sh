...
HD_PWD='C:/Users/Steven/Dropbox/Vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demo.vds -m64 -mode batch -messageDb vivado.pb -notrace -source demo.tcl
