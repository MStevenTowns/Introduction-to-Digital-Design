...
HD_PWD='/home/steven/Dropbox/Verilog/Homework/Assignment2/Problem1/Problem1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Problem1Mod.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Problem1Mod.tcl -notrace
