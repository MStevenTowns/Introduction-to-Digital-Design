...
HD_PWD='/home/steven/Dropbox/Verilog/Homework/Assignment2/Problem2/Problem2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Problem2Mod.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Problem2Mod.tcl
