...
HD_PWD='/home/steven/Dropbox/Verilog/Homework/Assignment2/Problem2/Problem2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Problem2Mod.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Problem2Mod.tcl -notrace
