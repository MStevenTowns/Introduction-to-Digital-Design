...
HD_PWD='/home/steven/Dropbox/Verilog/Homework/Assignment4/Problem3/Problem3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Problem3Mod.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Problem3Mod.tcl -notrace
