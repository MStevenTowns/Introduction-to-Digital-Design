...
HD_PWD='/home/steven/Dropbox/Verilog/Homework/Assignment4/Problem1/Problem1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Problem1Sim.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Problem1Sim.tcl -notrace
