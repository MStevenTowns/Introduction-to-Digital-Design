...
HD_PWD='/home/steven/Dropbox/Verilog/Homework/Assignment1/Problem3/Problem3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Problem3Mod.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Problem3Mod.tcl
