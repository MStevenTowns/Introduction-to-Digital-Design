...
HD_PWD='/home/steven/Dropbox/Verilog/Homework/Assignment5/Problem1/Problem1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Problem1Mod.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Problem1Mod.tcl
