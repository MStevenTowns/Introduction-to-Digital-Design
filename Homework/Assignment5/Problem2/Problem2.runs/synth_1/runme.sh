...
HD_PWD='/home/steven/Dropbox/Verilog/Homework/Assignment5/Problem2/Problem2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BitSlice.vds -m64 -mode batch -messageDb vivado.pb -notrace -source BitSlice.tcl
