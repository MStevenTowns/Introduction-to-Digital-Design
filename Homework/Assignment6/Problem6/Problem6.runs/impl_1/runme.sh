...
HD_PWD='/home/steven/Dropbox/Verilog/Homework/Assignment6/Problem6/Problem6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Problem6Mod.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Problem6Mod.tcl -notrace
