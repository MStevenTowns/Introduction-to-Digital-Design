...
HD_PWD='/home/steven/Dropbox/Verilog/Homework/Assignment6/Problem6/Problem6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Problem6Mod.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Problem6Mod.tcl
