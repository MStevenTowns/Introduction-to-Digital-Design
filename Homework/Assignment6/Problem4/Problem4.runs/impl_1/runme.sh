...
HD_PWD='/home/steven/Dropbox/Verilog/Homework/Assignment6/Problem4/Problem4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Problem4Mod.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Problem4Mod.tcl -notrace
