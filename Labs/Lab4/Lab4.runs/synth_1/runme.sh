...
HD_PWD='/home/steven/Dropbox/Verilog/Labs/Lab4/Lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab4Mod.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Lab4Mod.tcl
