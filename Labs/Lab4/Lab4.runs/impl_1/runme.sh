...
HD_PWD='/home/steven/Dropbox/Verilog/Labs/Lab4/Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab4Mod.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Lab4Mod.tcl -notrace
