...
HD_PWD='/home/steven/Dropbox/Vivado/Lab1/Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1Module.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Lab1Module.tcl
