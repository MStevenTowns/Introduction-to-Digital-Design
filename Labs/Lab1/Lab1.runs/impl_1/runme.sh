...
HD_PWD='/home/steven/Dropbox/Vivado/Lab1/Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1Module.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Lab1Module.tcl -notrace
